...
class HostCardEmulatorLogic(
    ...
    private fun processTokenTransfer(tokenJson: String) {
        try {
            ...
            val intent = Intent("org.unicitylabs.nfcwalletdemo.TOKEN_RECEIVED").apply {
    ...
    private fun processCryptoTransfer(cryptoJson: String) {
        try {
            ...
            val intent = Intent("org.unicitylabs.nfcwalletdemo.CRYPTO_RECEIVED").apply {
    ...
    private fun broadcastProgress(currentBytes: Int, totalBytes: Int) {
        try {
            val intent = Intent("org.unicitylabs.nfcwalletdemo.TRANSFER_PROGRESS").apply {
    ...
    private fun handleTestPing(commandApdu: ByteArray): ByteArray {
        return try {
            ...
            val testIntent = Intent("org.unicitylabs.nfcwalletdemo.NFC_TEST_RECEIVED").apply {
    ...
    private fun handleHybridHandshake(commandApdu: ByteArray): ByteArray {
        try {
            ...
            val intent = Intent("org.unicitylabs.nfcwalletdemo.HYBRID_HANDSHAKE_RECEIVED").apply {
